...
export function AppHeader() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full border-b-2 border-secondary/30 bg-gradient-to-r from-primary via-primary to-secondary shadow-lg relative overflow-hidden">
        {/* Fundo texturizado */}
